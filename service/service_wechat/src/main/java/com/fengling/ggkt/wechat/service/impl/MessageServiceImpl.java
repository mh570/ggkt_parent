...
import com.fengling.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        StringBuffer msg = this.text(param, "Java、HTML5前端+全栈、大数据、" +
    ...
    private String subscribe(Map<String, String> param) {
        return this.text(param,"感谢你关注，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
