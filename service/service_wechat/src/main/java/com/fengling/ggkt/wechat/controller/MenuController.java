package com.fengling.ggkt.wechat.controller;
...
import com.fengling.ggkt.wechat.utils.ConstantPropertiesUtil;
import com.fengling.ggkt.wechat.utils.HttpClientUtils;
...
public class MenuController {
    ...
    public Result getAccessToken() {
        ...
        try {
            ...
            e.printStackTrace();
            throw new HiException(20001,"获取access_token失败");
        }
    }
