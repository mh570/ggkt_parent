...
package com.fengling.ggkt.live.mtcloud;

import com.fengling.ggkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "52645";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "98516acfff3cdd6a8ba644309c57d003";
