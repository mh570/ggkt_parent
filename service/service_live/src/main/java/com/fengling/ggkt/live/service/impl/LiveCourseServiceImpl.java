package com.fengling.ggkt.live.service.impl;
...
import com.fengling.ggkt.live.mtcloud.CommonResult;
import com.fengling.ggkt.live.mtcloud.MTCloud;
import com.fengling.ggkt.live.service.*;
import com.fengling.ggkt.model.live.*;
import com.fengling.ggkt.live.mapper.LiveCourseMapper;
import com.fengling.ggkt.model.user.UserInfo;
import com.fengling.ggkt.model.vod.Teacher;
import com.fengling.ggkt.utils.DateUtil;
import com.fengling.ggkt.vo.live.*;
...
//         options 其他参数
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) { //成功
                ...
                throw new HiException(20001,"直播创建失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void removeLive(Long id) {
        ...
        if(liveCourse != null) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new HiException(20001,"删除直播课程失败");
            }
        }
    }
    ...
    //                *  options 		可选参数
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new HiException(20001,"修改直播课程失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public JSONObject getAccessToken(Long id, Long userId) {
        ...
        try {
            ...
            if(Integer.parseInt(commonResult.getCode()) == MTCloud.CODE_SUCCESS) {
                ...
                throw new HiException(20001,"获取失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void updateLifeConfig(LiveCourseConfigVo liveCourseConfigVo) {
        ...
        try {
            ...
            CommonResult<JSONObject> commonResult = JSON.parseObject(res, CommonResult.class);
            if(Integer.parseInt(commonResult.getCode()) != MTCloud.CODE_SUCCESS) {
                throw new HiException(20001,"修改配置信息失败");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
